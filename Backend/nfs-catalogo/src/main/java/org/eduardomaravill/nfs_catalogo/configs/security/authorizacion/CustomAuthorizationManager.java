package org.eduardomaravill.nfs_catalogo.configs.security.authorizacion;
...
import org.eduardomaravill.nfs_catalogo.models.users_models.Operation;
import org.eduardomaravill.nfs_catalogo.models.users_models.User;
import org.eduardomaravill.nfs_catalogo.repositories.users_respositories.IOperationRepository;
...
public class CustomAuthorizationManager implements AuthorizationManager<RequestAuthorizationContext> {
    ...
    private Predicate<Operation> getOperationPredicate(String url, String httpMethod) {
        return operation -> {
            ...
            if (url.startsWith("/doc") && operation.getHttpMethod().equals(httpMethod)){
                return true;
            }
