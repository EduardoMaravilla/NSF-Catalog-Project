...
const SliderDirectionComponent: FC<SliderDirectionComponentProps> = ({t,carConfig, setCarConfig}) => {
  ...
  const handleChange = (_: Event, newValue: number | number[]) => {
    ...
    localStorage.setItem("car-configuration-created", JSON.stringify(newCarConfig));
  };
