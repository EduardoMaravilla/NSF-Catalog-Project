...
CREATE TABLE `auxiliaries` (
  ...
  `auxiliar` varchar(25) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `cars` (
  ...
  `car_year` varchar(4) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id_cars`),
...
CREATE TABLE `init_skids` (
  ...
  `skid_type` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `modules` (
  ...
  `base_path` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `street_types` (
  ...
  `street_type` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `users` VALUES (1,'Eduardo Maravilla','EDUARDOMARAVILL','$2a$10$okVeao9mk63pg6tIgGWYFuzW0qDOyKaL/hscwXl1MLPb.Zd.wMdBW','eduardomaravilla@hotmail.com',1,1,1,1,1);
...
-- Dump completed on 2024-10-03 14:24:40
